import { ch as getDefaultExportFromCjs, d as defineComponent, b9 as useClipboard, a as useToast, dO as useAIAssistantHelpers, bv as useNodeTypesStore, at as useNDVStore, a0 as useRootStore, dn as useAssistantStore, L as useUIStore, q as computed, dP as MAX_DISPLAY_DATA_SIZE, dQ as isCommunityPackageName, c as useI18n, h as resolveComponent, c6 as resolveDirective, i as createElementBlock, g as openBlock, k as createBaseVNode, f as createCommentVNode, aB as withDirectives, t as toDisplayString, j as createVNode, m as unref, dR as InlineAskAssistantButton, w as withCtx, l as createTextVNode, F as Fragment, D as renderList, dS as NEW_ASSISTANT_SESSION_MODAL, ce as sanitizeHtml, bf as NodeConnectionTypes, dT as isObjectEmpty, r as ref, o as onMounted, n as normalizeClass, e as createBlock, b3 as VueMarkdown, _ as _export_sfc, b8 as N8nText, T as useWorkflowsStore, bz as _sfc_main$5, J as withModifiers, I as watch, bA as ElTree, B as normalizeStyle } from "./index-CiIsbhGU.js";
import { e as capitalize } from "./useCanvasOperations-mslYXO4A.js";
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_NodeErrorView = _sfc_main$4;
      const _component_n8n_icon_button = resolveComponent("n8n-icon-button");
...
const AiRunContentBlock = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__cssModules", cssModules$2]]);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("header", {
          ...
          runMeta.value?.node ? (openBlock(), createBlock(_sfc_main$5, {
            key: 0,
            ...
            createBaseVNode("ul", {
              ...
              (consumedTokensSum.value?.totalTokens ?? 0) > 0 ? (openBlock(), createElementBlock("li", {
                ...
                createVNode(_component_n8n_info_tip, {
                  ...
                  default: withCtx(() => [
                    createVNode(_sfc_main$2, { "consumed-tokens": consumedTokensSum.value }, null, 8, ["consumed-tokens"])
                  ]),
                  _: 1
                })
