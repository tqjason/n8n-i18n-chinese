const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-DiwrvWue.js","assets/index-C5ZAIWc3.js","assets/index-C5OXOcIJ.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-BzXjryqj.js","assets/chartjs.utils-DiADkGdC.js","assets/InsightsSummary-ccWlu9mP.js","assets/InsightsSummary-FixbpmPJ.css","assets/index-D2QjcjMM.js","assets/InsightsChartFailed-IFdgH8dQ.js","assets/InsightsChartFailureRate-DHktqg6f.js","assets/InsightsChartTimeSaved-C_FhEw2l.js","assets/InsightsChartAverageRuntime-CcgXJ5lE.js","assets/InsightsTableWorkflows-BpiZzCYP.js","assets/InsightsTableWorkflows-Blv_GPUj.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, gV as useInsightsStore, q as computed, b_ as defineAsyncComponent, r as ref, I as watch, h as resolveComponent, i as createElementBlock, g as openBlock, k as createBaseVNode, j as createVNode, w as withCtx, l as createTextVNode, t as toDisplayString, m as unref, c as useI18n, e as createBlock, f as createCommentVNode, n as normalizeClass, b6 as resolveDynamicComponent, aq as __vitePreload, _ as _export_sfc } from "./index-C5ZAIWc3.js";
import { I as InsightsSummary } from "./InsightsSummary-ccWlu9mP.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-DiwrvWue.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-BzXjryqj.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-IFdgH8dQ.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-DHktqg6f.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-C_FhEw2l.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-CcgXJ5lE.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-BpiZzCYP.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
