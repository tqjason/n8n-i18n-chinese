...
const zhCN = {
  ...
  "workflows.empty.easyAI": "测试一个即用型 AI 代理示例",
  "workflows.list.easyAI": "通过此即用型 AI 代理工作流测试 n8n 中 AI 的强大功能",
  ...
  "insights.banner.title": "过去{count}天的生产执行情况",
  ...
  "insights.banner.title.succeeded": "成功",
