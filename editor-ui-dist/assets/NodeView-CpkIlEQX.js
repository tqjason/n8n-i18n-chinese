const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreation-DGPpDUBV.js","assets/index-CiIsbhGU.js","assets/index-BaqhUIB7.css","assets/useCanvasOperations-mslYXO4A.js","assets/NodeCreation-RKvezEeg.css","assets/NodeDetailsView-D46eVi9a.js","assets/useRunWorkflow-Bdg4L_Wd.js","assets/pushConnection.store-DMJoz6iN.js","assets/import-curl-COhvlVyM.js","assets/FileSaver.min-C5t9PG20.js","assets/RunDataAi-CEdUKd8u.js","assets/useExecutionHelpers-BMZuW6Y6.js","assets/RunDataAi-CN9FrT9c.css","assets/useWorkflowActivate-CC9ihlhV.js","assets/NodeDetailsView-BcVu3kf0.css","assets/SetupWorkflowCredentialsButton-D_b14G2a.js"])))=>i.map(i=>d[i]);
import { d as defineComponent, h as resolveComponent, e as createBlock, g as openBlock, C as createEventBus, $ as useCssModule, bD as toRef, q as computed, r as ref, bE as refDebounced, i as createElementBlock, k as createBaseVNode, x as renderSlot, f as createCommentVNode, b2 as mergeProps, m as unref, n as normalizeClass, _ as _export_sfc, c as useI18n, bF as KeyboardShortcutTooltip, w as withCtx, j as createVNode, J as withModifiers, bG as reactive, o as onMounted, b6 as onUnmounted, l as createTextVNode, t as toDisplayString, b as useRouter, U as useRoute, a as useToast, a5 as useDocumentTitle, a6 as useWorkflowHelpers, bw as useNodeHelpers, bv as useNodeTypesStore, L as useUIStore, T as useWorkflowsStore, a2 as useSourceControlStore, p as useSettingsStore, bH as useCredentialsStore, bI as useEnvironmentsStore, bJ as useExternalSecretsStore, a0 as useRootStore, au as useExecutionsStore, a1 as useCanvasStore, a4 as useNpsSurveyStore, bK as useHistoryStore, a3 as useProjectsStore, u as useUsersStore, E as useTagsStore, at as useNDVStore, aO as useTemplatesStore, av as usePostHog, b9 as useClipboard, W as PLACEHOLDER_EMPTY_WORKFLOW_ID, bL as NEW_WORKFLOW_ID, V as VIEWS, bM as CanvasNodeRenderType, bN as START_NODE_TYPE, bO as getNodeViewTab, s as MAIN_HEADER_TABS, an as VALID_WORKFLOW_IMPORT_URL_REGEX, aj as useMessage, ak as MODAL_CONFIRM, bP as jsonParse, a8 as getResourcePermissions, bu as CHAT_TRIGGER_NODE_TYPE, bk as MANUAL_CHAT_TRIGGER_NODE_TYPE, I as watch, bQ as onBeforeRouteLeave, aA as onBeforeMount, aQ as useExternalHooks, bR as onActivated, bS as onDeactivated, y as onBeforeUnmount, bT as Suspense, bU as defineAsyncComponent, bV as N8nCallout, ap as __vitePreload, ab as EnterpriseEditionFeature, bW as AI_CREDITS_EXPERIMENT, z as nextTick, ah as useTelemetry, bX as tryToParseNumber, ai as nodeViewEventBus, bf as NodeConnectionTypes, bY as isValidNodeConnectionType, bZ as CanvasConnectionMode, b_ as historyBus, aG as sourceControlEventBus, b$ as getNodesWithNormalizedPosition, ar as h, c0 as NODE_CREATOR_OPEN_SOURCES, az as STICKY_NODE_TYPE, c1 as DRAG_EVENT_DATA_KEY } from "./index-CiIsbhGU.js";
import { u as useVueFlow, a as useCanvasMapping, C as Canvas } from "./useCanvasMapping-B21n_dd7.js";
import { u as useRunWorkflow } from "./useRunWorkflow-Bdg4L_Wd.js";
import { g as globalLinkActionsEventBus } from "./global-link-actions-Z7LMJQcr.js";
import { b as useNodeCreatorStore, c as useCanvasOperations, d as createCanvasConnectionHandleString } from "./useCanvasOperations-mslYXO4A.js";
import { u as useExecutionDebugging } from "./useExecutionDebugging-1PAgD17-.js";
import { u as usePushConnectionStore } from "./pushConnection.store-DMJoz6iN.js";
import { u as useBeforeUnload } from "./useBeforeUnload-Co8YTHCo.js";
import { g as getEasyAiWorkflowJson } from "./easyAiWorkflowUtils-DrEQiIGP.js";
import { u as useClearExecutionButtonVisible } from "./useClearExecutionButtonVisible-BPmF2RdM.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyNodeCreation = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreation-DGPpDUBV.js").then((n) => n.N), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyNodeDetailsView = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeDetailsView-D46eVi9a.js").then((n) => n.N), true ? __vite__mapDeps([5,1,2,3,6,7,8,9,10,11,12,13,14]) : void 0)
    );
    const LazySetupWorkflowCredentialsButton = defineAsyncComponent(
      async () => await __vitePreload(() => import("./SetupWorkflowCredentialsButton-D_b14G2a.js"), true ? __vite__mapDeps([15,1,2]) : void 0)
    );
    const $style = useCssModule();
