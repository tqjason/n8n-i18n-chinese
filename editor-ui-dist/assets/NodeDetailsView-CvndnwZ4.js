...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const LazyRunDataTable = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataTable-D_7jtutq.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0)
    );
    const LazyRunDataJson = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJson-DdVMJSDU.js"), true ? __vite__mapDeps([6,1,2,7,8,9,10,3,4,11,12,13]) : void 0)
    );
    const LazyRunDataSchema = defineAsyncComponent(
      async () => await __vitePreload(() => import("./index-Dgc86S58.js").then((n) => n.ip), true ? __vite__mapDeps([1,2]) : void 0)
    );
    ...
    const LazyRunDataSearch = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataSearch-g2wM6JRQ.js"), true ? __vite__mapDeps([14,1,2,15]) : void 0)
    );
    const props = __props;
    const emit = __emit;
