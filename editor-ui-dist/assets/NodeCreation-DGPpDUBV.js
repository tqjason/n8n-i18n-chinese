const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-C4RD13Ai.js","assets/index-CiIsbhGU.js","assets/index-BaqhUIB7.css","assets/useCanvasOperations-mslYXO4A.js","assets/NodeCreator-D9fmPdS2.css"])))=>i.map(i=>d[i]);
import { bv as useNodeTypesStore, q as computed, c as useI18n, T as useWorkflowsStore, eZ as MANUAL_TRIGGER_NODE_TYPE, gZ as CHAIN_LLM_LANGCHAIN_NODE_TYPE, bf as NodeConnectionTypes, bu as CHAT_TRIGGER_NODE_TYPE, g_ as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, g$ as OPEN_AI_NODE_TYPE, eR as SPLIT_IN_BATCHES_NODE_TYPE, h0 as NO_OP_NODE_TYPE, eU as WEBHOOK_NODE_TYPE, e$ as SCHEDULE_TRIGGER_NODE_TYPE, aQ as useExternalHooks, a1 as useCanvasStore, ei as AI_CATEGORY_LANGUAGE_MODELS, h1 as QA_CHAIN_NODE_TYPE, h2 as AGENT_NODE_TYPE, h3 as BASIC_CHAIN_NODE_TYPE, h4 as OPEN_AI_ASSISTANT_NODE_TYPE, az as STICKY_NODE_TYPE, eX as TRIGGER_NODE_CREATOR_VIEW, c0 as NODE_CREATOR_OPEN_SOURCES, d as defineComponent, L as useUIStore, r as ref, fD as useThrottleFn, o as onMounted, y as onBeforeUnmount, h as resolveComponent, i as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, k as createBaseVNode, j as createVNode, w as withCtx, m as unref, bF as KeyboardShortcutTooltip, bU as defineAsyncComponent, bT as Suspense, F as Fragment, ap as __vitePreload, h5 as getMidCanvasPosition, h6 as DEFAULT_STICKY_WIDTH, h7 as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-CiIsbhGU.js";
import { b as useNodeCreatorStore, t as transformNodeType, s as sortNodeCreateElements } from "./useCanvasOperations-mslYXO4A.js";
const useActions = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-C4RD13Ai.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
    const emit = __emit;
